...
')
# This is the same model as Model 2 but coding sel-reported gpm in the tree
# as 0.5 gpm and 0.5 msm
# This is because being a homesexual in Senegal is ilegal and some sel-reported
# gpm could be in fact msm
