...
source("analyses/scripts/MaleX/Model5/1.model.v5.R")

# Estimation of total of 15 parameters, including maleX
############################## Model 2 ########################################
m5.s <- getSample(m5.m, start=1000)
m5_map <- MAP(m5.m, start=1000)$parametersMAP
...
############################## Model 7 ########################################
m7.s <- getSample(m7.m, start=1000)
m7_map <- MAP(m7.m, start=1000)$parametersMAP
...
m02_AG.m3.s <- getSample(m02_AG_m3, start=1000)
m02_AG.m3_map <- MAP(m02_AG_m3, start=1000)$parametersMAP
...
m02_AG.m4.s <- getSample(m02_AG_m4, start=1000)
m02_AG.m4_map <- MAP(m02_AG_m4, start=1000)$parametersMAP
...
mC.m3.s <- getSample(mC_m3, start=800)
mC.m3_map <- MAP(mC_m3, start=800)$parametersMAP
...
mC.m4.s <- getSample(mC_m4, start=1000)
mC.m4_map <- MAP(mC_m4, start=1000)$parametersMAP
