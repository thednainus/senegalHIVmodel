...
prior <- createPrior(density = densities,
                     sampler = sampler,
                     lower = c(0.01, 0.01, 0.01, 1978, 0.01, 0.01, 0.01, 1978, 0, 0.0001, 0.3, 0.3, 1, 1),
                     upper = c(3, 3, 3, 2014, 3, 3, 3, 2014, 0.15, 0.15, 1, 1, 100, 100))
...
# Implementing the kebab job for the OSG
for(i in 1:3){
