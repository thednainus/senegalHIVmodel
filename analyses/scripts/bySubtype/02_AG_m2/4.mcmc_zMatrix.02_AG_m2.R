...
source("analyses/scripts/bySubtype/02_AG_m2/1.model.02_AG_m2.R.R")
#load the data that will be used in the subsequent analysis
source("analyses/scripts/bySubtype/02_AG_m2/2.load_data.02_AG_m2.R")
...
# Initial values based on the MAP analysis Erik did.
...
runZ <- readRDS("analyses/scripts/bySubtype/02_AG/Preliminary_results/FirstRun02_AG_forZmatrix.RDS")
...
outZ_02_AG <- runMCMC(bayesianSetup = bayesianSetup,  sampler = "DEzs", settings = settings )
#saveRDS(outZ, "z_andSuperHighLn2.RDS")
outZ_02_AG.2 <- runMCMC(bayesianSetup = outZ_02_AG)
saveRDS(outZ_o2_AG.2, "analyses/scripts/bySubtype/02_AG/Preliminary_results/02_AG_run1_withzMatrix.rds")
