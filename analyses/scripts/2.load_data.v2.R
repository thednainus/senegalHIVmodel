...
metadata <- read.csv( '../../inst/data/HIV_subtypes_summary_SENEGAL_noDups.csv') 
...
if (FALSE)
{
	...
	X11(); plot( dated.tree, edge.color = ecols, show.tip.lab = FALSE, no.mar=TRUE )
	...
	plot( dated.tree, edge.color = ecols2, show.tip.lab = FALSE, no.mar=TRUE )
}
