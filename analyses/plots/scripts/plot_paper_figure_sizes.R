...
Cm2_sizes["Model"] <- "Subtype C"

Cm2_sizes.l <- melt(Cm2_sizes, id.vars = c("times", "lower", "upper",
                                           "group", "group2", "Model"))
colnames(Cm2_sizes.l)[4] <- "Deme"
colnames(Cm2_sizes.l)[7] <- "Linetype"
...
AGm2_sizes["Model"] <- "Subtype 02_AG"

AGm2_sizes.l <- melt(AGm2_sizes, id.vars = c("times", "lower", "upper",
                                             "group", "group2", "Model"))
colnames(AGm2_sizes.l)[4] <- "Deme"
colnames(AGm2_sizes.l)[7] <- "Linetype"
...
# Combine dataframes
all_data <- rbind(Cm2_sizes.l, AGm2_sizes.l, m6_sizes.l)
