...
kableExtra::kable_styling(kable_input = kable_table, bootstrap_options = "striped", full_width = FALSE, position = "center", font_size = 12)
...
out <- kableExtra::kable_styling(kable_input = kable_table, bootstrap_options = c("striped", "hover"), full_width = FALSE, position = "center", font_size = 12)
