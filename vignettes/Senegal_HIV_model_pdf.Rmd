...
densities <-  function(par){
  # d1 to d3 and d5 to d7 I am using a gamma distribution with mean = R0 = 1.1 
  #    and sigma = 1
  # d4 and d8 uniform distribution between the start time and the final time 
  #    of our simualtions (t0 = 1978, and t1 = 2014)
...
prior <- createPrior(density = densities, 
                     sampler = sampler, 
                     lower = c(0.01, 0.01, 0.01, 1978, 0.01, 0.01, 0.01, 1978, 
                               0, 0.0001, 0.3, 0.3), 
                     upper = c(3, 3, 3, 2014, 3, 3, 3, 2014, 
                               0.15, 0.15, 1, 1))
```
